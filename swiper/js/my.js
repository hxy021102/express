                ...
                onFirstInit: function (swiper) {
                    setTimeout(function(){
                        ...
                        setTimeout(function(){
                            ...
                            setTimeout(function(){
                                $('.heart').css('top','10%');
                                $('.heart').css('-webkit-animation-name','shake');
                                $('.heart').css('-moz-animation-name','shake');
                                $('.heart').css('-ms-animation-name','shake');
                                $('.heart').css('animation-name','shake');
            ...
            $('.printloc').on('touchstart mousedown',function(e){
                ...
                check = setInterval(function(){
                    ...
                    if(nt - st > 600){
                        ...
                        setTimeout(function(){mySwiper1.swipeNext();},100);
                    }
                },100);
            });
...
setTimeout(function(){
   /* $('.heart').css('top','10%');
    ...
    $('.title-border').css('width','100%');
    $('.title-text').css('-webkit-animation-name','shake');*/
    $('.slide-2').css('background',"url('images/my/2back.jpg')");
    $('.slide-2').css('background-size',"100% 100%");
    $('.slide-3').css('background',"url('images/my/background1.png')");
